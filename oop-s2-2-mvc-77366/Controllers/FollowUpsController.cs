...
namespace FoodInspectionService.Controllers
{
    ...
    public class FollowUpsController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            _logger.LogInformation("Follow-up details viewed. FollowUpId: {FollowUpId}, InspectionId: {InspectionId}",
        ...
        public async Task<IActionResult> Create([Bind("Id,InspectionId,DueDate,Status,ClosedDate")] FollowUp followUp)
        {
            try
            {
                ...
                {
                    _logger.LogWarning("Follow-up creation failed validation. InspectionId: {InspectionId}, Status: {Status}",
                ...
                {
                    _logger.LogWarning("Follow-up creation blocked. InspectionId: {InspectionId}, DueDate: {DueDate} is before InspectionDate: {InspectionDate}",
                ...
                _logger.LogInformation("Follow-up created. FollowUpId: {FollowUpId}, InspectionId: {InspectionId}, DueDate: {DueDate}, Status: {Status}",
            ...
            {
                _logger.LogError(ex, "Error creating follow-up. InspectionId: {InspectionId}",
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,InspectionId,DueDate,Status,ClosedDate")] FollowUp followUp)
        {
            if (id != followUp.Id)
            {
                _logger.LogWarning("Follow-up edit id mismatch. RouteId: {RouteId}, FollowUpId: {FollowUpId}",
                    id, followUp.Id);
                return NotFound();
            }
            ...
            if (!ModelState.IsValid)
            {
                _logger.LogWarning("Follow-up update failed validation. FollowUpId: {FollowUpId}",
                    followUp.Id);
            ...
            try
            {
                ...
                {
                    _logger.LogWarning("Follow-up close blocked. FollowUpId: {FollowUpId}, ClosedDate missing.",
                        followUp.Id);
                ...
                _logger.LogInformation("Follow-up updated. FollowUpId: {FollowUpId}, Status: {Status}, ClosedDate: {ClosedDate}",
            ...
            catch (DbUpdateConcurrencyException ex)
            {
                ...
                {
                    _logger.LogWarning("Follow-up update failed because record not found. FollowUpId: {FollowUpId}",
                        followUp.Id);
                    return NotFound();
                }

                _logger.LogError(ex, "Concurrency error updating follow-up. FollowUpId: {FollowUpId}",
                    followUp.Id);
                throw;
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error updating follow-up. FollowUpId: {FollowUpId}",
                    followUp.Id);
                throw;
            }
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            try
            {
                ...
                if (followUp == null)
                {
                    _logger.LogWarning("Follow-up delete failed because record not found. FollowUpId: {FollowUpId}", id);
                    return NotFound();
                }
                ...
                _logger.LogInformation("Follow-up deleted. FollowUpId: {FollowUpId}, InspectionId: {InspectionId}",
                    followUp.Id, followUp.InspectionId);
            ...
            {
                _logger.LogError(ex, "Error deleting follow-up. FollowUpId: {FollowUpId}", id);
                throw;
            }
        }
